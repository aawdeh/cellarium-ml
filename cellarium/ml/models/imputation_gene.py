...
class ImputationModel_Gene(SingleCellVariationalInference):
    """Imputation model for missing genes in single-cell RNA-seq data.
    ...
    def compute_annealed_noise2self_weight_linear(self, 
                                           epoch: int, 
                                           step: int, 
                                           n_epochs_n2s_warmup: int | None,
                                           n_steps_n2s_warmup: int | None,
        ...
        """Computes the Noise2Self weight using delayed linear ramp-up.
